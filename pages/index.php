...
?>
<div class="page-header page-header-default" style="margin-top: -40px;">
					<div class="page-header-content" style="padding: 0px;">
					    ...
					    <ol class="carousel-indicators" style="padding-top: -150px;">
					    	...
					    	for ($i=0; $i < 10 ; $i++) { 
						    	if ($i == 0) {
						    		$caro_ind_class = 'class="active"';
						    	}
						    	else{
						    		$caro_ind_class = '';
						    	}
						    	?>
						    	<li data-target="#myCarousel" data-slide-to="<?php echo $i?>" <?php echo $caro_ind_class?>></li>
						    	<?php
						    }
					    	?>
					    ...
					    for ($i=0; $i < 10 ; $i++) { 
					    	if ($i == 0) {
					    		$caro_class = "item active";
					    	}
					    	else{
					    		$caro_class = "item";
					    	}
					    	?>
					    	<div class="<?php echo $caro_class?>">
					        <img src="assets/images/carosel.jpg" alt="Los Angeles" style="width:100%; height: 260px;">
					        <div class="carousel-caption">
					          <h4><a href=""> Anime Top 10</a></h4>
					          <p>Descrp Here</p>
					        </div>
					      </div>
					    	<?php
									...
									<div class="thumbnail no-padding">
										...
										<div class="thumb">
											...
											<div class="caption-overflow" style="">
												<span>
													<a href="#"  data-id="watch/anime/<?php echo $anime_title?>/<?php echo $anime_ID?>/dub/<?php echo $dub?>/episode/<?php echo $epi_num+$i?>" class="btn  btn-icon btn-xs" data-popup="lightbox"  id="getPage" style="background-color: white"><i class="icon-play3" style="color: black;" ></i></a>
								    	...
								    	<div class="caption text-center" style="min-height: 150px; max-height: 150px;">
								    		...
								    		<div style="overflow: hidden; min-height: 50px; max-height: 50px; font-size: 12px;">
								    				 <a href="#" data-id="Anime/anime_ID/<?php echo $anime_ID?>" id="getPage"><?php echo $anime_title?></a>	
								    		</div>
								    		<div style="overflow: hidden; min-height: 20px; max-height: 20px;">
								    			...
								    			<small class="display-block studio_link" >
								    				...
								    				if (!empty($studio_explode)) {
										    			...
										    			?>
										    			<a href="#" data-id="Studio/Name/<?php echo $value?>" id="getPage"><?php echo $value?></a>
										    			<?php
										    		}
								    				}
								    				else{
								    					?>
										    			<a  href="#" data-id="Studio" id="getPage"></a>
										    			<?php
								    				}
